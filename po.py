#NGAPAAIN KESINI BRE MAU RECODE
...
for xd in range(10000):
    ...
    f='/012.002; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/'
    g=random.randrange(1, 9)
    h=random.randrange(1, 4)
    i=random.randrange(1, 4)
    j=random.randrange(1, 4)
    k='Mobile Safari/533.4 3gpp-gba'
    ...
    c='; Redmi 6 Pro Build/OPM1.171019.019)'
...
╚═╝░░░░░╚═╝░░░░░░╚═╝░░╚═╝░░░░░░╚══════╝
	clear()
	alvino_xy(f'''\t{asu} ______                             {M}RECODE: ASU KONTOL BAJINGAN
  {K}STATUS:  PRIVAT SC
  {H}AUTHOR: MAHAMUD HASAN LIMON
  {X}THANKS TO ALVINO ADIJAYA 
  
               	        	{m}•{k}•{h}•{sir} Author : edan  {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
